...
export const cardUser = (user) =>{
    return `
        ...
        <div class="flex flex-col items-center pb-10">
            <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src=${user.image ?? placeHolderImage} alt="Bonnie image"/>
            <h5 class="mb-1 text-xl font-medium text-gray-900">${user.firstName}, ${user.lastName}</h5>
            <span class="text-sm text-gray-500">${user.company.title}</span>
