...
export const cardProduct = (product) => {
    return `
    <div class="w-full p-2 max-w-sm bg-white border border-gray-200 rounded-lg overflow-hidden shadow">
        <a href="#">
            <img class="w-full h-48 object-cover rounded" src=${product.thumbnail ?? placeHolderImage} alt="product image"/>
        </a>
        <div class="p-5 pb-5">
            <a href="#">
